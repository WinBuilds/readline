...
static size_t *inv_lbreaks, *vis_lbreaks;
...
static size_t prompt_last_invisible;
...
static size_t prompt_invis_chars_first_line;

static int prompt_last_screen_line;

static size_t prompt_physical_chars;
...
{
  char *r, *ret, *p;
  size_t l, rl, last, ignoring, ninvis, invfl, physchars;
  ...
  if (vis_lbreaks == 0)
    {
      ...
      inv_lbreaks = (size_t*)xmalloc (inv_lbsize * sizeof (size_t));
      vis_lbreaks = (size_t*)xmalloc (vis_lbsize * sizeof (size_t));
#if defined (HANDLE_MULTIBYTE)
...
rl_redisplay ()
{
  register int in, c, linenum, cursor_linenum;
  register char *line;
  register size_t out;

  int inv_botlin, lb_botlin, lb_linenum;
  size_t c_pos;
  int newlines, modmark;
...
{
  int prompt_size, i, real_screenwidth, newlines;
...
static size_t saved_last_invisible;
static size_t saved_visible_length;
static size_t saved_invis_chars_first_line;
static size_t saved_physical_chars;
     ...
     char *t;
{
  ...
  size_t oldlen, oldlast, oldplen, oldninvis, oldphyschars;
