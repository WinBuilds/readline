...
READLINE_DLL_IMPEXP size_t rl_visible_prompt_length;
...
/* complete.c */
READLINE_DLL_IMPEXP char _rl_find_completion_word PARAMS((size_t *, size_t *));
...
READLINE_DLL_IMPEXP size_t _rl_replace_text PARAMS((const char *, int, int));
...
READLINE_DLL_IMPEXP int _rl_qsort_string_compare PARAMS((const void *, const void *));
...
READLINE_DLL_IMPEXP extern procenv_t readline_top_level;
