...
READLINE_DLL_IMPEXP size_t rl_get_next_history PARAMS((int, int));
READLINE_DLL_IMPEXP size_t rl_get_previous_history PARAMS((int, int));
...
READLINE_DLL_IMPEXP size_t rl_history_search_forward PARAMS((int, int));
READLINE_DLL_IMPEXP size_t rl_history_search_backward PARAMS((int, int));
...
READLINE_DLL_IMPEXP size_t rl_expand_prompt PARAMS((char *));
...
//READLINE_DLL_IMPEXP extern Keymap rl_make_bare_keymap PARAMS((void));
//READLINE_DLL_IMPEXP extern Keymap rl_copy_keymap PARAMS((Keymap));
//READLINE_DLL_IMPEXP extern Keymap rl_make_keymap PARAMS((void));
//READLINE_DLL_IMPEXP extern void rl_discard_keymap PARAMS((Keymap));

//READLINE_DLL_IMPEXP extern Keymap rl_get_keymap_by_name PARAMS((const char *));
//READLINE_DLL_IMPEXP extern char *rl_get_keymap_name PARAMS((Keymap));
//READLINE_DLL_IMPEXP extern void rl_set_keymap PARAMS((Keymap));
//READLINE_DLL_IMPEXP extern Keymap rl_get_keymap PARAMS((void));
...
READLINE_DLL_IMPEXP char **rl_funmap_names PARAMS((void));
...
READLINE_DLL_IMPEXP size_t rl_insert_text PARAMS((const char *));
...
READLINE_DLL_IMPEXP extern const char *rl_library_version;		/* e.g., "4.2" */
READLINE_DLL_IMPEXP extern int rl_readline_version;			/* e.g., 0x0402 */

/* True if this is real GNU readline. */
READLINE_DLL_IMPEXP extern int rl_gnu_readline_p;

/* Flags word encapsulating the current readline state. */
READLINE_DLL_IMPEXP extern int rl_readline_state;

/* Says which editing mode readline is currently using.  1 means emacs mode;
   0 means vi mode. */
READLINE_DLL_IMPEXP extern int rl_editing_mode;

/* Insert or overwrite mode for emacs mode.  1 means insert mode; 0 means
   overwrite mode.  Reset to insert mode on each input line. */
READLINE_DLL_IMPEXP extern int rl_insert_mode;

/* The name of the calling program.  You should initialize this to
   whatever was in argv[0].  It is used when parsing conditionals. */
READLINE_DLL_IMPEXP extern const char *rl_readline_name;

/* The prompt readline uses.  This is set from the argument to
   readline (), and should not be assigned to directly. */
READLINE_DLL_IMPEXP extern char *rl_prompt;

/* The line buffer that is in use. */
READLINE_DLL_IMPEXP extern char *rl_line_buffer;

/* The location of point, and end. */
READLINE_DLL_IMPEXP extern size_t rl_point;
READLINE_DLL_IMPEXP extern size_t rl_end;

/* The mark, or saved cursor position. */
READLINE_DLL_IMPEXP extern int rl_mark;

/* Flag to indicate that readline has finished with the current input
   line and should return it. */
READLINE_DLL_IMPEXP extern int rl_done;

/* If set to a character value, that will be the next keystroke read. */
READLINE_DLL_IMPEXP extern int rl_pending_input;

/* Non-zero if we called this function from _rl_dispatch().  It's present
   so functions can find out whether they were called from a key binding
   or directly from an application. */
READLINE_DLL_IMPEXP extern int rl_dispatching;

/* Non-zero if the user typed a numeric argument before executing the
   current function. */
READLINE_DLL_IMPEXP extern int rl_explicit_arg;

/* The current value of the numeric argument specified by the user. */
READLINE_DLL_IMPEXP extern int rl_numeric_arg;

/* The address of the last command function Readline executed. */
READLINE_DLL_IMPEXP extern rl_command_func_t *rl_last_func;

/* The name of the terminal to use. */
READLINE_DLL_IMPEXP extern const char *rl_terminal_name;

/* The input and output streams. */
READLINE_DLL_IMPEXP extern FILE *rl_instream;
READLINE_DLL_IMPEXP extern FILE *rl_outstream;

/* If non-zero, then this is the address of a function to call just
   before readline_internal () prints the first prompt. */
READLINE_DLL_IMPEXP extern rl_hook_func_t *rl_startup_hook;

/* If non-zero, this is the address of a function to call just before
   readline_internal_setup () returns and readline_internal starts
   reading input characters. */
READLINE_DLL_IMPEXP extern rl_hook_func_t *rl_pre_input_hook;

/* The address of a function to call periodically while Readline is
   awaiting character input, or NULL, for no event handling. */
READLINE_DLL_IMPEXP extern rl_hook_func_t *rl_event_hook;

/* The address of the function to call to fetch a character from the current
   Readline input stream */
READLINE_DLL_IMPEXP extern rl_getc_func_t *rl_getc_function;

READLINE_DLL_IMPEXP extern rl_voidfunc_t *rl_redisplay_function;

READLINE_DLL_IMPEXP extern rl_vintfunc_t *rl_prep_term_function;
READLINE_DLL_IMPEXP extern rl_voidfunc_t *rl_deprep_term_function;

/* Dispatch variables. */
READLINE_DLL_IMPEXP extern Keymap rl_executing_keymap;
READLINE_DLL_IMPEXP extern Keymap rl_binding_keymap;

/* Display variables. */
/* If non-zero, readline will erase the entire line, including any prompt,
   if the only thing typed on an otherwise-blank line is something bound to
   rl_newline. */
READLINE_DLL_IMPEXP extern int rl_erase_empty_line;

/* If non-zero, the application has already printed the prompt (rl_prompt)
   before calling readline, so readline should not output it the first time
   redisplay is done. */
READLINE_DLL_IMPEXP extern int rl_already_prompted;

/* A non-zero value means to read only this many characters rather than
   up to a character bound to accept-line. */
READLINE_DLL_IMPEXP extern int rl_num_chars_to_read;

/* The text of a currently-executing keyboard macro. */
READLINE_DLL_IMPEXP extern char *rl_executing_macro;

/* Variables to control readline signal handling. */
/* If non-zero, readline will install its own signal handlers for
   SIGINT, SIGTERM, SIGQUIT, SIGALRM, SIGTSTP, SIGTTIN, and SIGTTOU. */
READLINE_DLL_IMPEXP extern int rl_catch_signals;
...
/* If non-zero, readline will install a signal handler for SIGWINCH
   ...
   to do that. */
READLINE_DLL_IMPEXP extern int rl_catch_sigwinch;

/* Completion variables. */
/* Pointer to the generator function for completion_matches ().
   NULL means to use rl_filename_completion_function (), the default
   filename completer. */
READLINE_DLL_IMPEXP extern rl_compentry_func_t *rl_completion_entry_function;
...
/* If rl_ignore_some_completions_function is non-NULL it is the address
   ...
   must be free()'ed. */
READLINE_DLL_IMPEXP extern rl_compignore_func_t *rl_ignore_some_completions_function;
...
READLINE_DLL_IMPEXP extern rl_completion_func_t *rl_attempted_completion_function;

/* The basic list of characters that signal a break between words for the
   completer routine.  The initial contents of this variable is what
   breaks words in the shell, i.e. "n\"\\'`@$>". */
READLINE_DLL_IMPEXP extern const char *rl_basic_word_break_characters;

/* The list of characters that signal a break between words for
   rl_complete_internal.  The default list is the contents of
   rl_basic_word_break_characters.  */
READLINE_DLL_IMPEXP extern char *rl_completer_word_break_characters;

/* Hook function to allow an application to set the completion word
   break characters before readline breaks up the line.  Allows
   position-dependent word break characters. */
READLINE_DLL_IMPEXP extern rl_cpvfunc_t *rl_completion_word_break_hook;

/* List of characters which can be used to quote a substring of the line.
   Completion occurs on the entire substring, and within the substring
   rl_completer_word_break_characters are treated as any other character,
   unless they also appear within this list. */
READLINE_DLL_IMPEXP extern const char *rl_completer_quote_characters;

/* List of quote characters which cause a word break. */
READLINE_DLL_IMPEXP extern const char *rl_basic_quote_characters;

/* List of characters that need to be quoted in filenames by the completer. */
READLINE_DLL_IMPEXP extern const char *rl_filename_quote_characters;

/* List of characters that are word break characters, but should be left
   in TEXT when it is passed to the completion function.  The shell uses
   this to help determine what kind of completing to do. */
READLINE_DLL_IMPEXP extern const char *rl_special_prefixes;
...
/* If non-zero, then this is the address of a function to call when
   ...
   or inserted. */
READLINE_DLL_IMPEXP extern rl_icppfunc_t *rl_directory_completion_hook;
...
READLINE_DLL_IMPEXP extern rl_icppfunc_t *rl_directory_rewrite_hook;
...
READLINE_DLL_IMPEXP extern rl_compdisp_func_t *rl_completion_display_matches_hook;

/* Non-zero means that the results of the matches are to be treated
   as filenames.  This is ALWAYS zero on entry, and can only be changed
   within a completion entry finder function. */
READLINE_DLL_IMPEXP extern int rl_filename_completion_desired;
...
READLINE_DLL_IMPEXP extern int rl_filename_quoting_desired;

/* Set to a function to quote a filename in an application-specific fashion.
   Called with the text to quote, the type of match found (single or multiple)
   and a pointer to the quoting character to be used, which the function can
   reset if desired. */
READLINE_DLL_IMPEXP extern rl_quote_func_t *rl_filename_quoting_function;

/* Function to call to remove quoting characters from a filename.  Called
   before completion is attempted, so the embedded quotes do not interfere
   with matching names in the file system. */
READLINE_DLL_IMPEXP extern rl_dequote_func_t *rl_filename_dequoting_function;

/* Function to call to decide whether or not a word break character is
   quoted.  If a character is quoted, it does not break words for the
   completer. */
READLINE_DLL_IMPEXP extern rl_linebuf_func_t *rl_char_is_quoted_p;

/* Non-zero means to suppress normal filename completion after the
   user-specified completion function has been called. */
READLINE_DLL_IMPEXP extern int rl_attempted_completion_over;

/* Set to a character describing the type of completion being attempted by
   rl_complete_internal; available for use by application completion
   functions. */
READLINE_DLL_IMPEXP extern int rl_completion_type;

/* Up to this many items will be displayed in response to a
   possible-completions call.  After that, we ask the user if she
   is sure she wants to see them all.  The default value is 100. */
READLINE_DLL_IMPEXP extern int rl_completion_query_items;

/* Character appended to completed words when at the end of the line.  The
   default is a space.  Nothing is added if this is '\0'. */
READLINE_DLL_IMPEXP extern int rl_completion_append_character;

/* If set to non-zero by an application completion function,
   rl_completion_append_character will not be appended. */
READLINE_DLL_IMPEXP extern int rl_completion_suppress_append;

/* Set to any quote character readline thinks it finds before any application
   completion function is called. */
READLINE_DLL_IMPEXP extern int rl_completion_quote_character;

/* Set to a non-zero value if readline found quoting anywhere in the word to
   be completed; set before any application completion function is called. */
READLINE_DLL_IMPEXP extern int rl_completion_found_quote;

/* If non-zero, the completion functions don't append any closing quote.
   This is set to 0 by rl_complete_internal and may be changed by an
   application-specific completion function. */
READLINE_DLL_IMPEXP extern int rl_completion_suppress_quote;
...
READLINE_DLL_IMPEXP extern int rl_completion_mark_symlink_dirs;

/* If non-zero, then disallow duplicates in the matches. */
READLINE_DLL_IMPEXP extern int rl_ignore_completion_duplicates;

/* If this is non-zero, completion is (temporarily) inhibited, and the
   completion character will be inserted as any other. */
READLINE_DLL_IMPEXP extern int rl_inhibit_completion;
