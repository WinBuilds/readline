...
READLINE_DLL_IMPEXP size_t history_total_bytes PARAMS((void));
...
READLINE_DLL_IMPEXP size_t history_search PARAMS((const char *, int));

/* Search the history for STRING, starting at history_offset.
   The search is anchored: matching lines must begin with string.
   DIRECTION is as in history_search(). */
READLINE_DLL_IMPEXP size_t history_search_prefix PARAMS((const char *, int));
